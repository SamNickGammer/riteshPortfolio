...
const Data = () => {
    return (
        <div className="home__data">
            <h1 className="home__title">Ritesh Kumar
                <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
            ...
            <p className="home__description">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Voluptas quos illo dolorum, dolorem vitae atque ad ullam harum. Animi minima eos dolorum rem. Accusantium est voluptas dolore temporibus natus esse!</p>
